<%-- 
    Document   : clothes_pickup
    Created on : 18 Jan, 2024, 10:56:03 PM
    Author     : Onkar
--%>
...
<body>
    ...
    <div class="container">
        ...
        <div class="jumbotron">
            <h1 style="text-align: center">Pickup Forms Clothes</h1>
            <hr>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <label>Address</label>
                    <textarea rows="3" class="form-control" name="txt_address" placeholder="Enter your address" onkeypress="javascript:return isAlphanumric(event)" required></textarea>
                </div>
            </div>
            </br>
